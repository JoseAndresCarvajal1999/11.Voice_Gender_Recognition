...
if mnt == true
    ...
    legend();
    title('Voice Gender Mountain''s Indexes with Euclidean Norm');
    xlabel('number of clusters');
    
    figure;
    plot(CC,Cal,'LineWidth',3);
    title('Voice Gender Mountain''s Calinski-Harabasz with Euclidean Norm');
    xlabel('number of clusters');
    ...
    shading interp;
    title('Voice Gender Mountain''s Silhouette Index with Euclidean Norm');
    xlabel('\sigma');
    ylabel('\beta');
    ...
    shading interp;
    title('Voice Gender Mountain''s Calinski-Harabasz Index with Euclidean Norm');
    xlabel('\sigma');
    ylabel('\beta');
...
%% Analysis 2. Substractive Clustering
...
plot(CC,Pur,'LineWidth',3,'DisplayName','Purity');
legend();
title('Voice Gender Subtractive''s Indexes with Euclidean Norm');
xlabel('number of clusters');

figure;
plot(CC,Cal,'LineWidth',3);
title('Voice Gender Subtractive''s Calinski-Harabasz with Euclidean Norm');
xlabel('number of clusters');
ylabel('calinski-harabasz index');
